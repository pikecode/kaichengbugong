...
class FulltextSearch
{
    ...
    public static function update($row, $add = false)
    {
        ...
        if ($data) {
            ...
            Xunsearch::instance('shop')->update($data, $add);
        }
    }
    ...
    public static function del($row)
    {
        ...
        if ($pid) {
            Xunsearch::instance('shop')->del($pid);
        }
    }
    ...
    public static function search($q, $page = 1, $pagesize = 20, $order = '', $fulltext = true, $fuzzy = false, $synonyms = false)
    {
        ...
        return Xunsearch::instance('shop')->search($q, $page, $pagesize, $order, $fulltext, $fuzzy, $synonyms);
    }
    ...
    public static function suggestion($q, $limit = 10)
    {
        ...
        return Xunsearch::instance('shop')->suggestion($q, $limit);
    }
    ...
    public static function hot()
    {
        ...
        return Xunsearch::instance('shop')->getXS()->search->getHotQuery();
    }
