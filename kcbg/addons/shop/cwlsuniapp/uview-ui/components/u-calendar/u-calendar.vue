		...
		<view class="u-calendar">
			...
			<view class="u-calendar__content">
				...
				<view class="u-calendar__content__item" :class="{
				 ...
				 @tap="dateClick(index)">
				 <!-- {{year}}-{{month}}-{{index+1}} -->
					<view style="color:#ff9d00 !important" v-if="arr.includes((formatNum(year)+'-'+formatNum(month)+'-'+formatNum((index + 1))))" class="u-calendar__content__item__inner" :style="{color: getColor(index,2)}">
						<view>{{ index + 1 }}</view>
					</view>
					
					<view v-else class="u-calendar__content__item__inner" :style="{color: getColor(index,2)}">
						<!-- {{}} -->
						<view>{{ index + 1 }} </view>
					</view>
