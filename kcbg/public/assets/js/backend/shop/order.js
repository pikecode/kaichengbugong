define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            // 批量打印发货单
            $(document).on('click', '.btn-dc', function () {


                var value = $(this).data("value");
                options = table.bootstrapTable('getOptions');
                // 获取当前的搜索条件
                // var searchParams = table.bootstrapTable('getOptions');
                console.log(options);
                var value = $('.panel-heading a[aria-expanded="true"]').data("value");
                ...
                options.queryParams = function (params) {
                    ...
                    window.open("/xSZaYJEibq.php/shop/order/ddd?"+sr+"&is_dc=1")
                    location.reload();
                    return params;
                };
                table.bootstrapTable('refresh', {});
