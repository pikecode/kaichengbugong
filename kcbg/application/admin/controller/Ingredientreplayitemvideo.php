 ...
 * @icon fa fa-circle-o
 */
class Ingredientreplayitemvideo extends Backend
{

    /**
     * Ingredientreplayitemvideo模型对象
     * @var \app\admin\model\Ingredientreplayitemvideo
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Ingredientreplayitemvideo;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $row) {
                $row->getRelation('ingredientreplayitem')->visible(['title']);
            }
