<template>
	<view>
		...
		<view class="goods-list">
			<view class="item" v-for="(item, index) in goods" :key="index" @click="goPage('/packageA/goods/detail?id=' + item.id)">
				...
				<view class="u-flex u-row-between u-p-15">
					...
					<text class="market_price u-tips-color" v-if="item.marketprice">￥{{ item.marketprice }}</text>
