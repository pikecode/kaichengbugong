	...
	<view>
		...
		<view class="order u-skeleton-rect">
			<view class="aftersale">
				<view class="item">
					<view class="left" @click="goPage('/packageA/goods/detail?id=' + info.goods_id)"><image :src="info.image" mode="aspectFill"></image></view>
					<view class="content" @click="goPage('/packageA/goods/detail?id=' + info.goods_id)">
