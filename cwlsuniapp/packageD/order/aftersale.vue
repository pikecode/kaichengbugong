<template>
	<view>
		...
		<view class="order u-skeleton-rect">
			<view class="item">
				<view class="left" @click="goPage('/packageA/goods/detail?id=' + goods.goods_id)"><image :src="goods.image" mode="aspectFill"></image></view>
				<view class="content" @click="goPage('/packageA/goods/detail?id=' + goods.goods_id)">
